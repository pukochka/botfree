...
import BasketDialogClear from "src/components/basket/sections/BasketDialogClear.vue";
...
import BasketProduct from "src/components/basket/sections/BasketProduct.vue";
